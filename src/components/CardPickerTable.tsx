...
import "../assets/css/CardPickerTable.css";
...
export const CardPickerTable: React.FC<CardPickerProps> = ({ game, players, currentPlayerId }) => {
                ...
                <div className='CardPickerContainer'>
                    <Grid container spacing={4} justify='center'>
                        {cards.map((card: CardConfig, index) => (
                            <Grid key={card.value} item xs style={{ padding: 3 }}>
                                <Slide in={true} direction={'right'} timeout={(1000 * index) / 2}>
                                    ...
                                    >
                                        ...
                                        <CardContent className='CardContent' style={{ paddingBottom: 0 }}>
                                            {card.value >= 0 && (
                                                <>
